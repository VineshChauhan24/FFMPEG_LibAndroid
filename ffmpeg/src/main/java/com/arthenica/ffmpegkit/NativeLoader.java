...
public class NativeLoader {
    ...
    static boolean isTestModeDisabled() {
        return System.getProperty("enable.ffmpegkit.kit.test.mode") == null;
    }
    ...
    static void loadFFmpegKit(boolean nativeFFmpegTriedAndFailed) {
        ...
        if (!nativeFFmpegTriedAndFailed && "arm-v7a".equals(loadNativeAbi())) {
            try {
                ...
                android.util.Log.i("ffmpegkit-kit", String.format("NEON supported armeabi-v7a ffmpegkit library not found. Loading default armeabi-v7a library.%s", Exceptions.getStackTraceString(e)));
            }
        }
